...
#real dimension
position_p1 = numpy.zeros((0,0,0))
position_p2 = numpy.zeros((0,0,0))
velocity_p1 = numpy.zeros((0,0,0))
velocity_p2 = numpy.zeros((0,0,0))
accelleration_p1 = numpy.zeros((0,0,0))
accelleration_p2 = numpy.zeros((0,0,0))
lin_mom_p1 = numpy.zeros((0,0,0))
lin_mom_p2 = numpy.zeros((0,0,0))
ang_mom_p1 = numpy.zeros((0,0,0))
ang_mom_p2 = numpy.zeros((0,0,0))
center_mass = numpy.zeros((0,0,0))
total_lin_mom = numpy.zeros((0,0,0))
total_ang_mom = numpy.zeros((0,0,0))
